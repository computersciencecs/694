#This file is used to split the bookcrossing dataset.
...
with open('bookcross8-4.csv') as f:
    for line in f:
...
train_set = pd.DataFrame(columns=['u', 'i', 'r', 't'])
val_set = pd.DataFrame(columns=['u', 'i', 'r', 't'])
test_set = pd.DataFrame(columns=['u', 'i', 'r', 't'])
