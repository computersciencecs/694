...
def my_test(model, data_path, start=0, end=sys.maxsize, batch_size=1, tensor_parallel_size=1):
    stop_tokens = []
...
def parse_args():
    ...
    parser.add_argument("--end", type=int, default=sys.maxsize)  # end index
    parser.add_argument("--batch_size", type=int, default=80)
    parser.add_argument("--tensor_parallel_size", type=int, default=1)
    parser.add_argument("--token", type=str, required=False, default="", help="HuggingFace token")
